...
class SantanderUpdateLoanDemandGatewayTest {
    ...
    void setUp() {
        ...
        santanderLoanDemandGateway = new SantanderUpdateLoanDemandGateway(mapper, santanderStoreService, loanApplicationAuditTrailService,
    ...
    void getOffersFromSantander() {
        ...
        StepVerifier.create(actualOffers)
                .consumeNextWith(response -> assertEquals(3, response.size()))
                .verifyComplete();
    }
